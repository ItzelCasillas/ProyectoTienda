...
<!-- <div class="header" id="home">
	<div class="container">
		<ul>
			...
			<li><i class="fa fa-phone" aria-hidden="true"></i> Contacto : 01234567898</li>
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="info@lipbeauty.com">info@lipbeauty.com</a></li>
		</ul>
	</div>
</div> -->
<!-- //header -->
